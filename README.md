...
1. Clone o repositório
  * `git clone https://github.com/tryber/sd-013-a-project-movie-cards-library-stateful.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-013-a-project-movie-cards-library-stateful`
...
7. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-013-a-project-movie-cards-library-stateful/pulls)
...
- Esse input deve apresentar o atributo ``
